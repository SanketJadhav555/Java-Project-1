...
public class TestMail {
	public static void main(String[] args) {
		try {
			String recipient = "Gada.alumni@gmail.com";
			...
			String htmlTextMessage = "" + "<html>"
					...
					+ "<h2 style='color:red;'>Welcome to Gada Electronics</h2>" + "<p>Hey,<br>"
					+ "Thanks for singing up with Gada Electronics.<br>"
					...
					+ "<span class='greenText'>Gada500</span><br><br>" + "Have a good day!<br>" + "</p>" + "</body>"
					+ "</html>";
